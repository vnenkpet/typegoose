...
export declare const pre: {
    ...
    <T>(method: "count" | "find" | "findOne" | "findOneAndRemove" | "findOneAndUpdate" | "update" | "insertMany" | "updateOne", fn: SimplePreSerialFn<T>): ClassDecorator;
    <T>(method: "count" | "find" | "findOne" | "findOneAndRemove" | "findOneAndUpdate" | "update" | "insertMany" | "updateOne", parallel: boolean, fn: SimplePreParallelFn<T>): ClassDecorator;
};
